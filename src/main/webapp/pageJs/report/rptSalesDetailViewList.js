...
function listData(pageDataObj) {
	...
	for (var i = 0; i < dataList.length; i++) {
		...
		trObj.append("<td>" + dataList[i].invite_user + "</td>");
		trObj.append("<td>" + dataList[i].format_rebate_expire_date + "</td>");
		...
		trObj.append("<td>" + dataList[i].exist_assets + "</td>");
		trObj.append("<td>" + dataList[i].format_buy_date + "</td>");
		trObj.append("<td>" + dataList[i].format_product_date + "</td>");
		trObj.append("<td>" + dataList[i].product_interest_rate + "</td>");
		trObj.append("<td>" + dataList[i].product_term + "</td>");
		tbody.append(trObj);
	}
...
function exportExcel(){    
    ...
    location.href = postUrl +"/report/export_sales_detail.do?begin_buy_date="+begin_buy_date+"&end_buy_date="+end_buy_date;    
} 
...
function refreshPage(currPage){
	...
	//var begin_buy_date = $("#begin_buy_date").val();
	//var end_buy_date = $("#end_buy_date").val();
	showPageForSplit('/report/findRptSalesDetailListByPage.do',listData,currPage);
}
