...
//--------------------------------------------------
        ...
        cat1Header.append('<div class="l1_icon_div_0_2_1_A"><label class="sprite-img-market_icon" style="background:url(/big-client/images/usertags/market_icon_' + tagIcon_eng_name + '.svg) no-repeat;"></label></div>');
