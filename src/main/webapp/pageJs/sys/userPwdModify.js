...
function confirmModifyPwd() {
	...
	var oldpwd_text = $("#oldpwd").val();
	var newpwd_text = $("#newpwd").val();
	var repeatpwd_text = $("#repeatpwd").val();

	var userInfoData = "oldpwd=" +  encodePassword( oldpwd_text );
	userInfoData += "&newpwd=" + encodePassword( newpwd_text );
	userInfoData += "&repeatpwd=" + encodePassword( repeatpwd_text );
