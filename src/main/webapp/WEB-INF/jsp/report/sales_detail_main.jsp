...
<html lang="en">
	...
	<body>
		...
		<script src="${localProjectName}/pageJs/report/rptSalesDetailViewList.js?v=${revision}"></script>
		<!-- 弹出提示框 start -->
		...
		<div id="operationDiv" class="operation_div" >
			<ul class="first">   	
				...
				<label class="date-label">起始购买日期：</label>
				<input id="begin_buy_date" name="begin_buy_date" type="text" class="date-input-text" onClick="WdatePicker()" placeholder="起始购买日期" style="width:137px"/>
				<label class="date-label">截止购买日期：</label>
				<input id="end_buy_date" name="end_buy_date" type="text" class="date-input-text" onClick="WdatePicker()" placeholder="截止购买日期" style="width:137px"/>
		...
		<div class="table-responsive data-list-table-div">
			<table class="table-hover evergrande-table"> <!-- table size and style are aligned in "evergrande-table" -->
				<thead>
					<tr class="thread-tr">
						<th><span>姓名</span></th>
						<th class="td_mobile_width"><span>手机号</span></th>
						<th><span>推荐人</span></th>
						...
						<th><span>现有资产</span></th>
						<th><span>购买日期</span></th>
						<th><span>产品成立日期</span></th>
						<th><span>产品利率</span></th>
						<th><span>产品期限</span></th>
					</tr>
				</thead>
