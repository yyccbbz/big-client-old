...
<html lang="en">
	...
	<body>
		...
		<script src="${localProjectName}/pageJs/report/officialUserViewList.js?v=${revision}"></script>
		<!-- 弹出提示框 start -->
		...
		<div id="operationDiv" class="operation_div" >
			<ul class="first">
				<form style="width: 600px" action="<%=request.getContextPath()%>/report/off/upload.do" id="fileForm" method="post" enctype="multipart/form-data" onsubmit="return check()">
