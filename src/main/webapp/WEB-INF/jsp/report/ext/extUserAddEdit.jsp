...
<div id="centerdiv" class="contend_div">
    <form id="addEditUserForm">
        ...
        <input type="hidden" id="edit_user_id" name="edit_user_id" value="${editUser.id}"/>
        ...
        <table id="center-tab" class="center-tab-css">
            ...
            <c:choose>
                <c:when test="${action == 'add'}">
                    <tr>
                        <td>手机号码</td>
                        <td><input type="text" class="form-control" id="mobile_no" name="mobile_no" onblur="checkMobile()" value="${editUser.mobile_no}"/></td>
                    </tr>
                </c:when>
                <c:otherwise>
                    <tr>
                        <td>手机号码</td>
                        <td><input type="text" class="form-control" disabled="disabled"  name="mobile_no" onblur="checkMobile()" value="${editUser.mobile_no}"/></td>
                    </tr>
                </c:otherwise>
            ...
            <tr>
                <td>返利失效日期</td>
                <td><input id="rebate_expire_date" name="rebate_expire_date" type="text" class="form-control" onClick="WdatePicker()" value="${editUser.rebate_expire_date}"/></td>
            </tr>
